...
if __name__ == "__main__":
    ...
    filename = "models_double/20230603-091943"
    ...
    if experiment_name == "no_shift" or experiment_name == "all":
        ...
        for k in range(num_trajectories):
            ...
            pred_states = train_double_model.trajectory_predict(model, input_states)
            gt_states = states[k][1:, :]
            gt_xy = xys[k][1:, :]
            l1s = params[k][1:, 2]  # [m, l, b, g]
            l2s = params[k][1:, 3]  # [m, l, b, g]
            pred_xy = simulator.get_double_xy(pred_states[:, 0], pred_states[:, 1], l1s, l2s)
