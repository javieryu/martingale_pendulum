...
if __name__ == "__main__":
    ...
    for k in range(10):
        ...
        pred_seq_cov_shift, true_seq_cov_shift = (
            data_cov_shift[k][1],
            data_cov_shift[k][0],
        )
        pred_seq_gcon_shift, true_seq_gcon_shift = (
            data_gcon_shift[k][1],
            data_gcon_shift[k][0],
        )
        ...
        plt.plot(ts, lb_no_shift, color="blue")
        plt.plot(ts, lb_cov_shift, color="green")
        plt.plot(ts, lb_gcon_shift, color="red")
